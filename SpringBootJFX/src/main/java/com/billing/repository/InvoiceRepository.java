...
public class InvoiceRepository {
	...
	private static final String SELECT_ITEM_DETAILS = "SELECT BID.*,PD.PRODUCT_NAME,PCD.CATEGORY_NAME,PD.PRINT_NAME FROM BILL_ITEM_DETAILS BID,PRODUCT_DETAILS PD,PRODUCT_CATEGORY_DETAILS PCD WHERE BILL_NUMBER=? AND BID.ITEM_NUMBER=PD.PRODUCT_ID AND PD.CATEGORY_ID=PCD.CATEGORY_ID";
	...
	public List<ItemDetails> getItemDetails(int billNumber) {
		...
		try {
			...
			while (rs.next()) {
				...
				itemDetails.setPrintName(rs.getString("PRINT_NAME"));
