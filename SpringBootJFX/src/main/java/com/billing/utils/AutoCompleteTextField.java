...
public class AutoCompleteTextField extends TextField {
    ...
    /**
     * Task to perform on click of any choice<br>
     */
    ...
    public void createTextField(SortedSet<String> entrySet,Task task) {
    	this.task = task;
        entries = (entrySet == null ? new TreeSet<String>() : entrySet);
