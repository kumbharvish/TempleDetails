...
public class ExpenseController implements TabContent {
	...
	public void putFocusOnNode() {
		cbExpenseType.requestFocus();
		// Name
		cbExpenseType.setOnKeyPressed(new EventHandler<KeyEvent>() {
			@Override
	...
	private TransactionDetails getTransactionDetails() {
		...
		donation.setTxnType(AppConstants.DEBIT);
		donation.setCategory(expenseTypeMap.get(cbExpenseType.getSelectionModel().getSelectedItem()));
		donation.setCategoryName(cbExpenseType.getSelectionModel().getSelectedItem());
		return donation;
	}
	...
	private void resetFields() {
		...
		donationDate.setValue(LocalDate.now());
		cbExpenseType.requestFocus();
		cbExpenseType.getSelectionModel().selectFirst();
	}
